...
INSERT INTO usuarios (id_personal, nombres, apellidos, correo, contraseña, estado, created_at) VALUES
(1, 'Juan', 'Pérez', 'jperez@ti.com', '123456', 1, NOW()),
(2, 'María', 'González', 'mgonzalez@ti.com', '123456', 1, NOW()),
(3, 'Carlos', 'Rodríguez', 'crodriguez@ti.com', '123456', 1, NOW()),
(4, 'Laura', 'Torres', 'ltorres@ti.com', '123456', 1, NOW()),
(5, 'Luis', 'Fernández', 'lfernandez@ti.com', '123456', 1, NOW()),
(6, 'Ana', 'Martínez', 'amartinez@ti.com', '123456', 1, NOW());
...
('Baterías', 'Baterías para laptops y dispositivos', 1, NOW()),
...
INSERT INTO repuestos (id_categoria, nombre, descripcion, precio_venta, stock, modelo, precio_compra, unidad_medida, marca, codigo, estado, created_at) VALUES
(1, 'Batería HP Pavilion', 'Batería original 11.1V 4400mAh', 120.00, 15, 'HP Pavilion 15', 80.00, 'Unidad', 'HP', 'BAT-HP-001', 1, NOW()),
(1, 'Batería Dell Latitude', 'Batería 14.8V 6600mAh', 150.00, 10, 'Dell Latitude', 100.00, 'Unidad', 'Dell', 'BAT-DELL-001', 1, NOW()),
...
('Tecnología Total', '987654321', 'Santa Cruz', 'Calle 21 #456', 'info@tecnologiatotal.com', '77722222', 1, NOW()),
...
('Promoción Verano 2026', 'Descuento en baterías', 15.00, '2026-01-01', '2026-02-28', 1, NOW()),
('Oferta SSD', 'Descuento especial en discos sólidos', 10.00, '2026-01-15', '2026-03-15', 1, NOW()),
...
(3, 5, 'Tarjeta', '2026-01-15', 'Venta múltiple', 185.00, 1, NOW()),
...
('Herramientas Electrónicas', 1, 1, NOW()),
...
(1, 'Multímetro Digital', 'H-001', 'excelente', 1, NOW()),
...
('Reparación de Pantalla', 'Cambio de display', 150.00, 90, 1, NOW()),
('Actualización de Firmware', 'Actualización de BIOS/firmware', 60.00, 30, 1, NOW()),
('Diagnóstico General', 'Revisión completa del sistema', 50.00, 120, 1, NOW()),
...
(4, 5, '2026-01-20', NULL, NULL, 'Pendiente de programación', 'pendiente', NOW()),
(5, 3, '2026-01-22', NULL, NULL, 'Esperando aprobación del cliente', 'pendiente', NOW()),
(6, 6, '2026-01-25', NULL, NULL, 'Pendiente de programación', 'pendiente', NOW());
...
(1, 1, 'Técnico Principal', 2.50, '2026-01-12 08:30:00', 1, NOW()),
(1, 2, 'Técnico Asistente', 2.00, '2026-01-12 08:30:00', 1, NOW()),
(2, 2, 'Técnico Principal', 0.00, '2026-01-14 09:00:00', 1, NOW()),
(3, 1, 'Técnico Principal', 1.50, '2026-01-17 09:30:00', 1, NOW()),
(4, 3, 'Supervisor', 0.00, '2026-01-20 08:00:00', 1, NOW()),
(5, 2, 'Técnico Principal', 0.00, '2026-01-22 08:00:00', 1, NOW()),
(6, 6, 'Técnico Principal', 0.00, '2026-01-25 08:00:00', 1, NOW());
...
(1, 1, 'Multímetro usado para verificación', 1, NOW()),
(1, 3, 'Destornillador para apertura', 1, NOW()),
(3, 1, 'Verificación de continuidad', 1, NOW()),
(3, 4, 'Pinza para manejo de cables', 1, NOW()),
(5, 6, 'Estación de soldadura preparada', 1, NOW()),
(6, 2, 'Osciloscopio para diagnóstico', 1, NOW());
...
(2, 1, 1, 'Batería nueva instalada', 1, NOW()),
...
(1, '2026-01-01', 5, 30, 'Estante A-01', 'Baterías HP Pavilion', 1, 1, NOW()),
(2, '2026-01-01', 3, 20, 'Estante A-02', 'Baterías Dell Latitude', 1, 1, NOW()),
...
('LOTE-001-2026', 1, '2026-01-05', 2, 2, 80.00, '2027-12-31', 'ACTIVO', 'Lote de baterías HP', NOW()),
...
(1, 1, 1, NULL, NULL, 1, 'ENTRADA', 2, 0, 0, 2, 'Compra inicial baterías HP', 'COMP-001', 'LOTE-001', '2026-01-05 10:00:00'),
...
(1, 1, NULL, 2, NULL, 5, 'SALIDA', 0, 1, 2, 1, 'Venta batería HP', 'VENTA-002', 'Cliente María López', '2026-01-12 15:00:00'),
(1, 1, NULL, 3, NULL, 5, 'SALIDA', 0, 1, 1, 0, 'Venta batería HP', 'VENTA-003', 'Cliente Tecnología XYZ', '2026-01-15 16:00:00'),
(6, 4, NULL, 3, NULL, 5, 'SALIDA', 0, 1, 2, 1, 'Venta RAM', 'VENTA-003', 'Cliente Tecnología XYZ', '2026-01-15 16:00:00'),
(6, 4, NULL, 4, NULL, 5, 'SALIDA', 0, 1, 1, 0, 'Venta RAM', 'VENTA-004', 'Cliente Pedro Ramírez', '2026-01-18 10:00:00'),
...
UNION ALL
SELECT 'Inventario Físico', COUNT(*) FROM inventario_fisico;